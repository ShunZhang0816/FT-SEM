...
bias_plot <- function(data,title){
  bias <- ggplot(data, aes(x = Sample size, y = Bias, group = Method,
...
RMSE_plot <- function(data,title){
  RMSE <- ggplot(data, aes(x = Sample size, y = RMSE, group = Method,
                           shape = factor(Method, levels = c("FT-SEM","lm_parent","lm")),
                           linetype = factor(Method, levels = c("FT-SEM","lm_parent","lm")))) +
    geom_point(size = 2) +  
    geom_line(linewidth = 0.8) +
...
Coverage_plot <- function(data,title){
  Coverage <- ggplot(data, aes(x = Sample size, y = Coverage, group = Method,
                               shape = factor(Method, levels = c("FT-SEM","lm_parent","lm")),
                               linetype = factor(Method, levels = c("FT-SEM","lm_parent","lm")))) +
    geom_point(size = 2) +  
    geom_line(linewidth = 0.8) +
...
CI_plot <- function(data,title){
  CI <- ggplot(data, aes(x = Sample size, y = CILength, group = Method,
                         shape = factor(Method, levels = c("FT-SEM","lm_parent","lm")),
                         linetype = factor(Method, levels = c("FT-SEM","lm_parent","lm")))) +
    geom_point(size = 2) +  
    geom_line(linewidth = 0.8) +
...
Type_one_error_rate_plot <- function(data,title){
  Type_one_error_rate <- ggplot(data, aes(x = Sample size, y = Type_one_error_rates, group = Method,
                                          shape = factor(Method, levels = c("FT-SEM","lm_parent","lm")),
                                          linetype = factor(Method, levels = c("FT-SEM","lm_parent","lm")))) +
    geom_point(size = 2) +  
    geom_line(linewidth = 0.8) +
